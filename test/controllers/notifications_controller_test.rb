...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { email: @notification.email, format: @notification.format, send_at: @notification.send_at } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { email: @notification.email, format: @notification.format, send_at: @notification.send_at } }
